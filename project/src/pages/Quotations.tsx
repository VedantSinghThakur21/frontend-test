...
// import { QuotationPDFViewer } from '../lib/generateQuotationPDF';
    ...
    <div className="space-y-6">
      ...
      > */}
        {/* {previewQuotation && (
          ...
          //   inquiry={inquiries.find(i => i.id === previewQuotation.inquiry_id)}
          //   client={clients.find(c => c.id === inquiries.find(i => i.id === previewQuotation.inquiry_id)?.client_id)}
          //   costCalculation={costCalculations.find(c => c.id === previewQuotation.cost_calculation_id)}
          // />
        )} */}
      {/* </Modal> */}
    </div>
